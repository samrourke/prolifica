...
export default function TermsAndConditions() {
  return (
    <main data-lenis-prevent className={styles.container}>
      <div className={styles.textContainer}>
        ...
        <div className={styles.section}>
          <h2 className={styles.h2}>Hyperlinking to Our Content</h2>
          <p className={styles.p}>
            The following organizations may link to our Website without prior
            written approval:
          </p>
          <ul className={styles.ul}>
            <li className={styles.li}>Government agencies;</li>
            <li className={styles.li}>Search engines;</li>
            <li className={styles.li}>News organizations;</li>
            <li className={styles.li}>
          ...
          <ul className={styles.ul}>
            ...
            <li className={styles.li}>dot.com community sites;</li>
            <li className={styles.li}>
              associations or other groups representing charities;
            </li>
            <li className={styles.li}>online directory distributors;</li>
            <li className={styles.li}>
          ...
          <p className={styles.p}>
            ...
            visibility of the hyperlink compensates the absence of Company Name;
          ...
          <p className={styles.p}>
            ...
            sending an e-mail to Company Name. Please include your name, your
          ...
          <ul className={styles.ul}>
            <li className={styles.li}>By use of our corporate name; or</li>
            <li className={styles.li}>
        ...
        <div className={styles.section}>
          <h2 className={styles.h2}>iFrames</h2>
          <p className={styles.p}>
        ...
        <div className={styles.section}>
          <h2 className={styles.h2}>Content Liability</h2>
          <p className={styles.p}>
        ...
        <div className={styles.section}>
          <h2 className={styles.h2}>Reservation of Rights</h2>
          <p>
        ...
        <div className={styles.section}>
          <h2 className={styles.h2}>Removal of links from our website</h2>
          <p className={styles.p}>
